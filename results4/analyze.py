...
def modelSampledHBList(filename,perFileModel,pdb,HBcount,HBList,dehydronCount,modeledAtomsInDD,uniqueAtomCountInDDD):
	...
	numNonUniqueAtomsInDDD = len(uniqueAtomsInDDD)
	modeledAtomsInDD.write(filename+","+str(numUniqueAtomsInDDD)+","+str(numNonUniqueAtomsInDDD)+","+str(uniqueAtomCountInDDD)+"\n")
...
def writeHeaders(perDehydronOut,perHbondOut,perFileOutput,perFileModel,modeledAtomsInDD):
	...
	modeledAtomsInDD.write("filename,modeledUniqueAtomsInDDD,numNonUniqueAtomsInDDD,actualUniqueAtomsInDDD\n")
